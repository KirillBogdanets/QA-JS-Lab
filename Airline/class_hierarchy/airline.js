...
const fs = require('fs');
const LightCivilAircraft = require("./aircraft_types/lightCivilAircrafts");
const MiddleCivilAircraft = require("./aircraft_types/middleCivilAircrafts");
const HeavyCivilAircraft = require("./aircraft_types/heavyCivilAircrafts");

const LightCargoAircraft = require("./aircraft_types/lightCargoAircrafts");
const MiddleCargoAircraft = require("./aircraft_types/middleCargoAircrafts");
const HeavyCargoAircraft = require("./aircraft_types/heavyCargoAircraft");
const CivilAircraft = require("./aircraft_types/civilAircrafts");

/**
 * class for creating new airline and, reading file with all aircrafts and making statistic
 */
class Airline {
    constructor(name){
        this.name = name;
     ...
     */
    totalAircraftsInfo(arrayWithAllAircrafts){
     ...
     */
    aircraftsSorter(arrayWithAllAircrafts){
     ...
     */
    rangeValuesWorker(arrayWithAllAircrafts, firstValue, secondValue){
